...
class pageWidgetsStats {
  ...
  static initWidgetsChartJS() {
    ...
    if (chartWidgetLinesCon !== null) {
      chartWidgetLines = new Chart(chartWidgetLinesCon, {type: 'line', data: chartWidgetLinesData, options: chartOptions });
    }

    if (chartWidgetLinesCon2 !== null) {
      chartWidgetLines2 = new Chart(chartWidgetLinesCon2, {type: 'line', data: chartWidgetLinesData2, options: chartOptions });
    }

    if (chartWidgetLinesCon3 !== null) {
      chartWidgetLines3 = new Chart(chartWidgetLinesCon3, {type: 'line', data: chartWidgetLinesData3, options: chartOptions });
    }

    if (chartWidgetLinesCon4 !== null) {
      chartWidgetLines4 = new Chart(chartWidgetLinesCon4, {type: 'line', data: chartWidgetLinesData4, options: chartOptions });
    }
  }
