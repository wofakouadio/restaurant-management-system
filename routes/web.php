...
/** SUPER ADMINISTRATOR ROUTING **/
Route::middleware(['web', 'super-admin'])->prefix('super-admin')->group(function (){
...
Route::middleware(['web', 'admin'])->prefix('admin')->group(function (){
    ...
    /** Dashboard **/
    Route::get('/', [AdminController::class, 'index'])->name('ad.dashboard');
//    Route::get('/get-pending-orders', [DashboardController::class, 'pending_orders_counter'])->name('sa.pending-orders-counter');

    /** Users **/
//    Route::get('/new-user', [AdminController::class, 'new_user_page'])->name('sa.new-user');
//    Route::post('/register-new-user', [UserController::class, 'store'])->name('sa.register-new-user');
//    Route::get('/all-users', [AdminController::class, 'all_users'])->name('sa.all-users');
//    Route::get('/get-all-roles', [AdminController::class, 'get_all_roles'])->name('sa.get-all-roles');
//    Route::get('/get-user', [UserController::class, 'edit'])->name('sa.get-user');
//    Route::put('/update-user', [UserController::class, 'update'])->name('sa.update-user');
//    Route::delete('/delete-user', [UserController::class, 'delete'])->name('sa.delete-user');
