                                ...
                                <div class="options-container">
                                    ...
                                    <div class="options-overlay bg-black-75">
                                        <div class="options-overlay-content">
                                            ...
                                            <a class="btn btn-sm btn-alt-primary" data-bs-toggle="modal" data-bs-target="#AddNewOrder" data-menu_id="{{$menu->menu_id}}">
                                                <i class="fa fa-pencil-alt opacity-50 me-1"></i> Order
                                            </a>
                                        </div>
                                    </div>
                                </div>
